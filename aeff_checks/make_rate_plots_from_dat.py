...
histtitle = detector + ' ' + selection + ' Event Selection ' + 'I3 Event Rates'

ebins = np.loadtxt(datadir+"/"+"nue_CC_osc_event_rates_vs_energy_uponly.dat",usecols=[0])
...
title = r'$\nu_e$ CC'
colour = 'r'
osc_rate_1D_map = np.loadtxt(datadir+"/"+"nue_CC_osc_event_rates_vs_energy_uponly.dat",usecols=[1])
...
title = r'$\nu_{\mu}$ CC'
colour = 'b'
osc_rate_1D_map = np.loadtxt(datadir+"/"+"numu_CC_osc_event_rates_vs_energy_uponly.dat",usecols=[1])
all_osc_rate_hists[flavour+int_type] = {}
all_osc_rate_hists[flavour+int_type]['hist'] = osc_rate_1D_map
all_osc_rate_hists[flavour+int_type]['title'] = title
all_osc_rate_hists[flavour+int_type]['colour'] = colour
...
title = r'$\nu_{\tau}$ CC'
colour = 'g'
osc_rate_1D_map = np.loadtxt(datadir+"/"+"nutau_CC_osc_event_rates_vs_energy_uponly.dat",usecols=[1])
all_osc_rate_hists[flavour+int_type] = {}
all_osc_rate_hists[flavour+int_type]['hist'] = osc_rate_1D_map
all_osc_rate_hists[flavour+int_type]['title'] = title
all_osc_rate_hists[flavour+int_type]['colour'] = colour
...
all_osc_rate_hists['nuallnc']['hist'] = np.loadtxt(datadir+"/"+"nu_nc_osc_event_rates_vs_energy_uponly.dat",usecols=[1])
...
title = r'$\bar{\nu}_e$ CC'
colour = 'r'
osc_rate_1D_map = np.loadtxt(datadir+"/"+"nuebar_CC_osc_event_rates_vs_energy_uponly.dat",usecols=[1])
all_osc_rate_hists[flavour+int_type] = {}
all_osc_rate_hists[flavour+int_type]['hist'] = osc_rate_1D_map
all_osc_rate_hists[flavour+int_type]['title'] = title
all_osc_rate_hists[flavour+int_type]['colour'] = colour
...
title = r'$\bar{\nu}_{\mu}$ CC'
colour = 'b'
osc_rate_1D_map = np.loadtxt(datadir+"/"+"numubar_CC_osc_event_rates_vs_energy_uponly.dat",usecols=[1])
all_osc_rate_hists[flavour+int_type] = {}
all_osc_rate_hists[flavour+int_type]['hist'] = osc_rate_1D_map
all_osc_rate_hists[flavour+int_type]['title'] = title
all_osc_rate_hists[flavour+int_type]['colour'] = colour
...
title = r'$\bar{\nu}_{\tau}$ CC'
colour = 'g'
osc_rate_1D_map = np.loadtxt(datadir+"/"+"nutaubar_CC_osc_event_rates_vs_energy_uponly.dat",usecols=[1])
all_osc_rate_hists[flavour+int_type] = {}
all_osc_rate_hists[flavour+int_type]['hist'] = osc_rate_1D_map
all_osc_rate_hists[flavour+int_type]['title'] = title
all_osc_rate_hists[flavour+int_type]['colour'] = colour
...
all_osc_rate_hists['nubarallnc']['hist'] = np.loadtxt(datadir+"/"+"nubar_nc_osc_event_rates_vs_energy_uponly.dat",usecols=[1])
...
plt.grid()
plt.title(histtitle)
filename = "AllFlavours_%s_%s_OscRatesFromI3.png"%(detector,selection)
...
title = r'$\nu_e$ CC'
colour = 'r'
unosc_rate_1D_map = np.loadtxt(datadir+"/"+"nue_CC_unosc_event_rates_vs_energy_uponly.dat",usecols=[1])
...
title = r'$\nu_{\mu}$ CC'
colour = 'b'
unosc_rate_1D_map = np.loadtxt(datadir+"/"+"numu_CC_unosc_event_rates_vs_energy_uponly.dat",usecols=[1])
all_unosc_rate_hists[flavour+int_type] = {}
all_unosc_rate_hists[flavour+int_type]['hist'] = unosc_rate_1D_map
all_unosc_rate_hists[flavour+int_type]['title'] = title
all_unosc_rate_hists[flavour+int_type]['colour'] = colour
...
all_unosc_rate_hists['nuallnc']['hist'] = np.loadtxt(datadir+"/"+"nu_nc_unosc_event_rates_vs_energy_uponly.dat",usecols=[1])
...
title = r'$\bar{\nu}_e$ CC'
colour = 'r'
unosc_rate_1D_map = np.loadtxt(datadir+"/"+"nuebar_CC_unosc_event_rates_vs_energy_uponly.dat",usecols=[1])
all_unosc_rate_hists[flavour+int_type] = {}
all_unosc_rate_hists[flavour+int_type]['hist'] = unosc_rate_1D_map
all_unosc_rate_hists[flavour+int_type]['title'] = title
all_unosc_rate_hists[flavour+int_type]['colour'] = colour
...
title = r'$\bar{\nu}_{\mu}$ CC'
colour = 'b'
unosc_rate_1D_map = np.loadtxt(datadir+"/"+"numubar_CC_unosc_event_rates_vs_energy_uponly.dat",usecols=[1])
all_unosc_rate_hists[flavour+int_type] = {}
all_unosc_rate_hists[flavour+int_type]['hist'] = unosc_rate_1D_map
all_unosc_rate_hists[flavour+int_type]['title'] = title
all_unosc_rate_hists[flavour+int_type]['colour'] = colour
...
all_unosc_rate_hists['nubarallnc']['hist'] = np.loadtxt(datadir+"/"+"nubar_nc_unosc_event_rates_vs_energy_uponly.dat",usecols=[1])
...
plt.grid()
plt.title(histtitle)
filename = "AllFlavours_%s_%s_UnoscRatesFromI3.png"%(detector,selection)
plt.savefig(filename)  
