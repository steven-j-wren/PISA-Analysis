...
title = r'$\nu_e$ CC'
colour = 'r'
aeff_1D_map = np.loadtxt("Data/DC/mlarson/16-01/Aeff/FromI3/nue_CC_truecoszencut_DeepCore_NBI_effective_areas_vs_energy_uponly.dat",usecols=[1])
...
title = r'$\nu_{\mu}$ CC'
colour = 'b'
aeff_1D_map = np.loadtxt("Data/DC/mlarson/16-01/Aeff/FromI3/numu_CC_truecoszencut_DeepCore_NBI_effective_areas_vs_energy_uponly.dat",usecols=[1])
all_msu_aeff_hists[flavour+int_type] = {}
all_msu_aeff_hists[flavour+int_type]['hist'] = aeff_1D_map
all_msu_aeff_hists[flavour+int_type]['title'] = title
all_msu_aeff_hists[flavour+int_type]['colour'] = colour
...
title = r'$\nu_{\tau}$ CC'
colour = 'g'
aeff_1D_map = np.loadtxt("Data/DC/mlarson/16-01/Aeff/FromI3/nutau_CC_truecoszencut_DeepCore_NBI_effective_areas_vs_energy_uponly.dat",usecols=[1])
all_msu_aeff_hists[flavour+int_type] = {}
all_msu_aeff_hists[flavour+int_type]['hist'] = aeff_1D_map
all_msu_aeff_hists[flavour+int_type]['title'] = title
all_msu_aeff_hists[flavour+int_type]['colour'] = colour
...
all_msu_aeff_hists['nuallnc']['hist'] = np.loadtxt("Data/DC/mlarson/16-01/Aeff/FromI3/nu_nc_truecoszencut_DeepCore_NBI_effective_areas_vs_energy_uponly.dat",usecols=[1])
...
title = r'$\bar{\nu}_e$ CC'
colour = 'r'
aeff_1D_map = np.loadtxt("Data/DC/mlarson/16-01/Aeff/FromI3/nuebar_CC_truecoszencut_DeepCore_NBI_effective_areas_vs_energy_uponly.dat",usecols=[1])
all_msu_aeff_hists[flavour+int_type] = {}
all_msu_aeff_hists[flavour+int_type]['hist'] = aeff_1D_map
all_msu_aeff_hists[flavour+int_type]['title'] = title
all_msu_aeff_hists[flavour+int_type]['colour'] = colour
...
title = r'$\bar{\nu}_{\mu}$ CC'
colour = 'b'
aeff_1D_map = np.loadtxt("Data/DC/mlarson/16-01/Aeff/FromI3/numubar_CC_truecoszencut_DeepCore_NBI_effective_areas_vs_energy_uponly.dat",usecols=[1])
all_msu_aeff_hists[flavour+int_type] = {}
all_msu_aeff_hists[flavour+int_type]['hist'] = aeff_1D_map
all_msu_aeff_hists[flavour+int_type]['title'] = title
all_msu_aeff_hists[flavour+int_type]['colour'] = colour
...
title = r'$\bar{\nu}_{\tau}$ CC'
colour = 'g'
aeff_1D_map = np.loadtxt("Data/DC/mlarson/16-01/Aeff/FromI3/nutaubar_CC_truecoszencut_DeepCore_NBI_effective_areas_vs_energy_uponly.dat",usecols=[1])
all_msu_aeff_hists[flavour+int_type] = {}
all_msu_aeff_hists[flavour+int_type]['hist'] = aeff_1D_map
all_msu_aeff_hists[flavour+int_type]['title'] = title
all_msu_aeff_hists[flavour+int_type]['colour'] = colour
...
all_msu_aeff_hists['nubarallnc']['hist'] = np.loadtxt("Data/DC/mlarson/16-01/Aeff/FromI3/nubar_nc_truecoszencut_DeepCore_NBI_effective_areas_vs_energy_uponly.dat",usecols=[1])
...
plt.axis([0,80,ymin-(0.2*(ymax-ymin)),ymax+(0.2*(ymax-ymin))])
